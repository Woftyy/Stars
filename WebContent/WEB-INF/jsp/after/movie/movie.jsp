  ...
  <li role="presentation" ><a href="#" id="a3">最多评论</a></li>
	...
	<script>
	 ...
	 $(document).ready(function(){
         ...
         $('#con').load('${pageContext.request.contextPath}/after/movie_theme');
         //单击 a 链接，加载 a.html
         $("#a1").click(function(){
             $('#con').load('${pageContext.request.contextPath}/after/movie_theme');
         ...
         //单击 b 链接，加载 b.html
         $("#a2").click(function(){
             $('#con').load('${pageContext.request.contextPath}/after/movie_hot');
         });
         $("#a3").click(function(){
             $('#con').load('${pageContext.request.contextPath}/after/movie_reply');
         });
     });
